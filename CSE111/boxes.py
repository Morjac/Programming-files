...
#input information
man_items = int(input("Enter the number of items: "))
boxes = int(input ("Enter the number of items per box: "))

x = math.ceil(man_items / boxes)

print(f"For {man_items} items, packing {boxes} items in each box, you will need {x} boxes.")